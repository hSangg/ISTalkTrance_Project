...
\begin{abstract}
    In the age of digital communication and telework, the need for advanced conversation
    processing becomes increasingly important. This study proposes an integrated system
    capable of speech separation, speaker recognition, individualized content summarization,
    and voice translation while preserving the original voice characteristics. The approach
    combines acoustic features such as MFCC, XVector, and DVector with modern deep learning
    models including RNN, GMM, and Transformer. The system is trained and tested on a labeled
    conversation dataset. Experimental results demonstrate that the system achieves high accuracy
    in speaker discrimination and content summarization.
\end{abstract}
...
\begin{table*}[htbp]
    \centering
    \caption{Evaluation Results by Metric Across Folds and Models}
    \label{tab:asr-results-pivot}
    \resizebox{\textwidth}{!}{
